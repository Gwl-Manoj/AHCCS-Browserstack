		...
		String result = null;
		 try
		 {
			 ...
			 if(iserror==true)
			 {
				 ...
				 {
					 Reporter.log("The validation message is same for Ethinicity Dropdown i.e "+actual_validation, true);
					 Reporter.log(" ", true);
				 }
		...
		String result = null;
		 try
		 {
			 ...
			 if(iserror==true)
			 {
				 ...
				 if(actual_validation.equals(expected_validation))
				 {
					 Reporter.log("The validation message is same for race dropdown i.e "+actual_validation, true);
					 Reporter.log(" ", true);
				 }
		...
		String result = null;
		 try
		 {
			 ...
			 if(iserror==true)
			 {
				 ...
				 if(actual_validation.equals(expected_validation))
				 {
					 Reporter.log("The validation message is same for state of Birth i.e "+actual_validation, true);
					 Reporter.log(" ", true);
				 }
